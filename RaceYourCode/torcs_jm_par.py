...
# drive_example is kept as a reference only.
# The active entry point is at the bottom of this file (drive_modular).



#############################################
# MODULAR DRIVE LOGIC WITH PARAMETERS
#############################################
...
STEER_GAIN = 15          # Dial down further — at 180km/h, even small steer inputs have big effect
...
ENABLE_TRACTION_CONTROL = False # Try disabling — at 179 min speed you're barely losing traction anyway
